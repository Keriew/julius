...
static int big_people_image(figure_type type)
{
    switch (type) {
        ...
        case FIGURE_LIGHTHOUSE_SUPPLIER:
            return assets_get_image_id("Areldir", "Slave_Walker", "Slave Portrait");
            break;
        case FIGURE_MESS_HALL_COLLECTOR:
            return assets_get_image_id("Areldir", "Mess_Hall", "M Hall Portrait");
            break;
        ...
        case FIGURE_BARKEEP_SUPPLIER:
            return assets_get_image_id("Areldir", "Entertainment", "Barkeep Portrait");
        default:
            break;
    }
