        ...
        if (map_property_is_draw_tile(grid_offset)) {
            ...
            if (building_monument_is_monument(b)) {
                switch (map_property_multi_tile_size(grid_offset)) {
                    case 2: image_draw(assets_get_image_id("Areldir", "UI_Elements", "2 Mon MapIcon"), x_view, y_view - 1); break;
                    case 3: image_draw(assets_get_image_id("Areldir", "UI_Elements", "3 Mon MapIcon"), x_view, y_view - 2); break;
                    case 4: image_draw(assets_get_image_id("Areldir", "UI_Elements", "4 Mon MapIcon"), x_view, y_view - 3); break;
                    case 5: image_draw(assets_get_image_id("Areldir", "UI_Elements", "5 Mon MapIcon"), x_view, y_view - 4); break;
                    case 7: image_draw(assets_get_image_id("Areldir", "UI_Elements", "7 Mon MapIcon"), x_view, y_view - 6); break;
                }
            } else {
                switch (map_property_multi_tile_size(grid_offset)) {
                    ...
                    case 7: image_draw(assets_get_image_id("Areldir", "UI_Elements", "7x7 Map Icon"), x_view, y_view - 6);
                }
            }
        }
    } else {
