...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_2_DESC, "Los sacerdotes proveen entretenimiento y hermosean las casas, aumentando el atractivo del vecindario sin necesidad de decoraciones adicionales."},
