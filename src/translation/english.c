...
static translation_string all_strings[] = {
    ...
    {TR_ADVISOR_CULTURE_REASON_1, "More entertainment venues would increase this rating"},
    {TR_ADVISOR_CULTURE_REASON_2, "Wider spread of different religions would increase this rating"},
    {TR_ADVISOR_CULTURE_REASON_3, "Better access to education would increase this rating"},
    {TR_ADVISOR_CULTURE_REASON_4, "City culture is perfect!"},
    {TR_ADVISOR_CULTURE_REASON_5, "More performances would increase this rating"},
