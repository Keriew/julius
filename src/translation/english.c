...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_1, "Merchant caravans buy their goods up to 20% more." },
    {TR_BUILDING_CARAVANSERAI_POLICY_1_TITLE, "Consilium Acquisitionem" },
    {TR_BUILDING_CARAVANSERAI_POLICY_2, "Merchant caravans sell their goods up to 20% cheaper" },
    {TR_BUILDING_CARAVANSERAI_POLICY_1_TITLE, "Consilium Quantitas" },
    {TR_BUILDING_CARAVANSERAI_POLICY_3, "Merchant caravans can carry 50% more but their speed is reduced by 10%." },
