...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_DESC, "Les caravanes marchandes profitent de ce lieu de repos et consomment de la nourriture. Les marchandises peuvent être achetées jusqu'à 10% plus cher et vendus 10% moins cher dans votre cité"},
