...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_CARAVANSERAI_POLICY_1, "Les caravanes marchandes achètent leurs biens jusqu'à 20% plus cher." },
    {TR_BUILDING_CARAVANSERAI_POLICY_2_TITLE, "Consilium Acquisitionem" },
    {TR_BUILDING_CARAVANSERAI_POLICY_2, "Les caravanes marchandes vendent leurs biens jusqu'à 20% moins cher." },
    {TR_BUILDING_CARAVANSERAI_POLICY_3_TITLE, "Consilium Quantitas" },
    {TR_BUILDING_CARAVANSERAI_POLICY_3, "Les caravanes marchandes peuvent porter 50% plus mais leur vitesse est réduite de 10%." },
