...
static translation_string all_strings[] = {
	...
	{TR_CONFIG_SHOW_MILITARY_SIDEBAR, "Legionen am rechten Bildschirmrand anzeigen"},
    ...
    {TR_BUILDING_GRAND_TEMPLE_ADD_MODULE, "Tempel einer Gottheit wirdmen" },
    ...
    {TR_BUILDING_WORK_CAMP_DESC, "Arbeiter versammeln sich hier, um Materialien an Baustellen zu liefern." },{TR_HEADER_HOUSING, "Behausung"},
